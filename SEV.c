...
// elbinary bta3 elarkam 7awlnah 3ala elcalculator lehex 3ashn yrsem elarkam abcdefg
...
static void SEV_voidHelp(uint8 u8SevIndxCpy , uint8 u8SevValueCpy)
{
	...
	for (u8CntLoc = 0 ;u8CntLoc < 7 ;u8CntLoc++)
	{
		DIO_enuWritePin(SEV_astrConfig[u8SevIndxCpy].au8SevPinMap[u8CntLoc],GET_BIT(u8SevValueCpy,u8CntLoc));
	     //elpin ely hayktb 3aleha   ,get bit (elregister ely fyh elrakam 5 maslan,haya5od bit bit y7otohm 3ala elpins,haya5od rasmet elrakam mn elmatrix ely fo2)
	}
